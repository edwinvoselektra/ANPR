...
export default function CameraWizard() {
  ...
  return (
    <div className="wizard">
      <div className="page-header"><div><h1>Geavanceerde bestaande camera-invoer</h1><p>Compatibiliteitsroute voor bestaande transportinstellingen. CGI is geen ITSAPI. Zones in dit platform configureren de Dahua-camera niet.</p></div></div>
      {step === 1 && (
      ...
      <section className="card wizard-card">
        ...
        {step === 4 && (
          <>
            ...
            <div className="form-grid">
              <div className="field"><label>ANPR-provider</label><select value={form.anprProvider} onChange={(event) => set("anprProvider", event.target.value)}><option value="NONE">Uitgeschakeld</option><option value="DAHUA_CGI">Dahua CGI-eventstream (alternatief)</option></select></div>
